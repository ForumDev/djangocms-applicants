...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.abbr'
        db.add_column(u'applicants_event', 'abbr',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.abbr'
        db.delete_column(u'applicants_event', 'abbr')
    ...
    models = {
        ...
        u'applicants.event': {
            ...
            'abbr': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '20', 'null': 'True', 'blank': 'True'}),
