...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Note.created_at'
        db.delete_column(u'applicants_note', 'created_at')

        # Adding field 'Note.created'
        db.add_column(u'applicants_note', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 10, 7, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Note.created_at'
        db.add_column(u'applicants_note', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 10, 7, 0, 0)),
                      keep_default=False)

        # Deleting field 'Note.created'
        db.delete_column(u'applicants_note', 'created')
    ...
    models = {
        ...
        u'applicants.note': {
            ...
            'applicant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['applicants.Applicant']", 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 7, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
