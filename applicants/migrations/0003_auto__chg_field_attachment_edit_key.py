...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Attachment.edit_key'
        db.alter_column(u'applicants_attachment', 'edit_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100))

    def backwards(self, orm):

        # Changing field 'Attachment.edit_key'
        db.alter_column(u'applicants_attachment', 'edit_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
