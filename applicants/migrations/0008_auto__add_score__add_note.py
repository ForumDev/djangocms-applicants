...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Score'
        db.create_table(u'applicants_score', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myauth.User'], blank=True)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['applicants.Applicant'], blank=True)),
        ))
        db.send_create_signal(u'applicants', ['Score'])

        # Adding model 'Note'
        db.create_table(u'applicants_note', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('note', self.gf('django.db.models.fields.TextField')(default='')),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['myauth.User'], blank=True)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['applicants.Applicant'], blank=True)),
        ))
        db.send_create_signal(u'applicants', ['Note'])


    def backwards(self, orm):
        # Deleting model 'Score'
        db.delete_table(u'applicants_score')

        # Deleting model 'Note'
        db.delete_table(u'applicants_note')
    ...
    models = {
        u'applicants.applicant': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': u"orm['applicants.Event']", 'blank': 'True'}),
